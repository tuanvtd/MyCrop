...
public class UCropActivity extends AppCompatActivity {
        ...
        for (ViewGroup cropAspectRatioView : mCropAspectRatioViews) {
            cropAspectRatioView.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    mGestureCropImageView.zoomOutImage(initialScale);

                    float k =  ((AspectRatioTextView) ((ViewGroup) v).getChildAt(0)).getAspectRatio(v.isSelected());


                    mGestureCropImageView.setTargetAspectRatio(k);
    ...
    private void setupRotateWidget() {
        ...
        ((HorizontalProgressWheelView) findViewById(R.id.rotateScrollWheel))
        ...
        ((HorizontalProgressWheelView) findViewById(R.id.rotateScrollWheel)).setMiddleLineColor(mActiveControlsWidgetColor);
    ...
    private void setupScaleWidget() {
        ...
        ((HorizontalProgressWheelView) findViewById(R.id.scale_scroll_wheel))
                .setScrollingListener(new HorizontalProgressWheelView.ScrollingListener() {
                    ...
                    public void onScroll(float delta, float totalDistance) {
                        if (delta > 0) {
                            float zomIn = mGestureCropImageView.getCurrentScale()
                                    + delta * ((mGestureCropImageView.getMaxScale() - mGestureCropImageView.getMinScale()) / SCALE_WIDGET_SENSITIVITY_COEFFICIENT);
                            Log.e("kh45", "zoomIn: "+zomIn);
                            mGestureCropImageView.zoomInImage(zomIn);
                        } else {
                            float zomOut = mGestureCropImageView.getCurrentScale()
                                    + delta * ((mGestureCropImageView.getMaxScale() - mGestureCropImageView.getMinScale()) / SCALE_WIDGET_SENSITIVITY_COEFFICIENT);
                            Log.e("kh45", "zomOut: "+zomOut);
                            mGestureCropImageView.zoomOutImage(zomOut);
                        }
                    }
    ...
    /**
     * Adds view that fmShowLoadercovers everything below the Toolbar.
